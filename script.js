    ...
    window.addEventListener('scroll', () => {
        ...
        if(skillsTop-windowHeight<-350)
        {
            ...
            else if(percent[i].classList.contains("bstrp-bar"))
            {
                percent[i].style.animationName="percent2"
            }
            else if(percent[i].classList.contains("java-bar"))
            {
                percent[i].style.animationName="percent3"
            }
            else if(percent[i].classList.contains("javascript-bar"))
            {
            ...
            else if(percent[i].classList.contains("hibernate-bar"))
            {
